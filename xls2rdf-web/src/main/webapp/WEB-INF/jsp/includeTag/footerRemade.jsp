...
<div id="footer" class="container-fluid bg-dark">
    <div class="row justify-content-center text-center p-2">
      <div class="col-auto text-secondary text-center">
              <span class="fw-bold">Xls2Rdf by</span> 
                    <a class="text-decoration-none" href="http://blog.sparna.fr" target="_blank"><span class="fw-light fw-bold" style="color: #df6919;">Thomas Francart</span></a>, 
              ...
              &nbsp;|&nbsp;
              <span class="fw-bold">version : ${applicationData.buildVersion} (${applicationData.buildTimestamp})</span> 
