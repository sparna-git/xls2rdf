      ...
      <a class="navbar-brand fw-normal" href="${sessionData.baseUrl}/"><i class="fa-regular fa-house" style="color: #df6919; font-size: 25px"></i> &nbsp;Excel 2 RDF</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a id="api-button" class="menu-item nav-link active ${view eq 'api' ? 'highlight' : ''}" href="${sessionData.baseUrl}/"><fmt:message key="home"/></a>
            </li>
            <li class="nav-item">
              <a id="doc-button" class="menu-item nav-link active ${view eq 'doc' ? 'highlight' : ''}" href="${sessionData.baseUrl}/doc"><fmt:message key="doc"/></a>
            </li>
            <li class="nav-item">
