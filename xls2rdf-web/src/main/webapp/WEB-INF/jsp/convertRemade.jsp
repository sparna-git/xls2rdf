...
<html>
  <head>
    ...
    <link rel="canonical" href="https://xls2rdf.sparna.fr/convert/remade" />
    ...
    <div class="container mt-5">
      <form action="convert" method="post" enctype="multipart/form-data">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <span class="fst-italic fw-bold form-text fw-lighter text-center">
              03/05/2022 : The converter is now available as an <a class="text-danger" href="${sessionData.baseUrl}/">API</a> !
            </span>   
        </div>
      </form>
    </div>
