...
public class Xls2RdfRestControllerAdvice {
    ...
    public ResponseEntity<RestExceptionRendererer> xls2RdfRestControllerExceptionHandler(Xls2RdfRestControllerException ex) {
        return this.prepareResponseException(ex, HttpStatus.BAD_REQUEST, LocalDateTime.now());
    }
    ...
    public ResponseEntity<RestExceptionRendererer> exceptionHandler(Exception ex) {
        return this.prepareResponseException(ex, HttpStatus.INTERNAL_SERVER_ERROR, LocalDateTime.now());
    }
    ...
    private ResponseEntity<RestExceptionRendererer> prepareResponseException(Throwable t, HttpStatus status, LocalDateTime dateTime){
